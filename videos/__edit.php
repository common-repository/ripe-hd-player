  ...
  <form method="POST" action="<?php echo $_SERVER['REQUEST_URI']; ?>" onsubmit="return hitasoft_player_validate();">
    ...
    <table cellpadding="0" cellspacing="10">
      ...
      <tr>
        ...
        <td><input type="text" id="_video" name="video" size="50" value="<?php echo $data->video; ?>"></td>
      </tr>
      <tr>
        <td width="30%"><?php _e("Video Description " ); ?></td>
        <td><textarea id="description" name="description" cols="50" rows="10"><?php echo $data->description; ?></textarea></td>
      </tr>
    </table>
    <br />

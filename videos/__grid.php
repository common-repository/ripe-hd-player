...
class hitasoft_player_Videos_Table extends WP_List_Table {
...
<?php
	$table = new hitasoft_player_Videos_Table();
...
<br />
<form id="hitasoft_player-videos-filter" method="get" style="width:99%;">
